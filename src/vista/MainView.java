...
public class MainView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/cofee_resized.png"))); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        Imagen.setHorizontalAlignment((int)CENTER_ALIGNMENT);
        Imagen.setVerticalAlignment((int)CENTER_ALIGNMENT);
    ...
    private void bIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bIniciarSesionActionPerformed
        try {
            c.IniciarSesion(new Usuario(txtUsu.getText(), new String(txtPassword.getPassword())));
